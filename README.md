...
--------------------------------------------------------------------------------------------------------------------------------------------------------
The seventh group (A6) of scenario 4 in round 7 (https://github.com/FranklinMRJ/cenarios_iot/blob/main/cenário4_42min.csv) contains data that have a higher delay value than the other data samples:
